...
public class StringMethod {
        ...
        public static void main(String[] args) {
                ...
                System.out.println(modifiedString.lastIndexOf("an", 3));// an ka index kya hai 3rd index se start karte
                                                                        // hue

                System.out.println(name.equals("Anand Raj Bind"));// kya name String Anand String ke equals hai
                System.out.println(name.equalsIgnoreCase("anand raj bind"));// kya name String Anand String ke equals
                                                                            // hai case sensitive ko ignore karte huye
